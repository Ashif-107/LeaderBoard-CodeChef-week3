...
function Participants(props) {
  ...
  return (
    <div className=' bg-[#3B5987] p-5 mt-5 lg:mt-0 lg:mr-10 w-full lg:w-[35vw] xl:w-[35vw] rounded-t-3xl lg:rounded-3xl  overflow-x-hidden lg:h-[450px]'>
          ...
          <div key={index} className='flex justify-between text-white border-t-2 pt-3 pb-3'>
            ...
            <div className='flex flex-wrap items-center justify-end'>
              ...
              {props.isNetPositive[index] ? (
                <Image src={Positive} alt="Positive" className='mr-2' />
              ) : (
                <Image src={Negative} alt="Negative" className='mr-2' />
              )}
            </div>
          </div>
        ) : (
